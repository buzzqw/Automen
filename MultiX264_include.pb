...
ver.s="v1."+Str(#pb_editor_buildcount)+"."+Str(#pb_editor_compilecount)
;
Enumeration
  #Window_0
EndEnumeration
...
If LoadFont(1,GetCurrentDirectory()+"DejaVuSansMono.ttf", 8) Or LoadFont(1,"DejaVuSansMono.ttf", 8)
...
Procedure Open_Window_1()
  If OpenWindow(#Window_1, 216, 0, 507, 85, "Select PGC and click Accept PGC",  #PB_Window_SystemMenu | PB_Window_TitleBar )
    ...
    ButtonGadget(#pgcaccept,380,10,120,comboheight,"Accept PGC")
    ComboBoxGadget(#pgc, 100, 10, 270, comboheight)
    TextGadget(#Text_122, 10, 10, 80, comboheight, "Select PGC", #PB_Text_Center | #PB_Text_Border)
...
Procedure Open_Window_0()
  If OpenWindow(#Window_0, 336, 289, 520, 430, "MultiX264 "+ver.s,  #PB_Window_SystemMenu | #PB_Window_MinimizeGadget | #PB_Window_TitleBar|#PB_Window_ScreenCentered)
    ...
    TextGadget(#PB_Any,125,380,375,20,"Buzzqw's Multi X264 encoder GUI",#PB_Text_Border|#PB_Text_Center)
    ...
    PanelGadget(#Panel_0, 30, 120, 460, 240)
      ...
      TextGadget(#PB_Any,20,23,90,20,"Width/Height") : StringGadget(#widthf,110,20,50,20,"") :  StringGadget(#heightf,165,20,50,20,"")
      TextGadget(#PB_Any,20,48,85,20,"FPS/Num Frames") : StringGadget(#frameratef,110,45,50,20,"") : StringGadget(#framecountf,165,45,50,20,"")
      
      EditorGadget(#basicfile, 20,70, 195,130)
      
      
      TextGadget(#PB_Any,240,28,60,20,"Pass to do")
      ComboBoxGadget(#pass, 330, 25,115,comboheight )
      AddGadgetItem(#pass,-1,"1 pass")
      AddGadgetItem(#pass,-1,"2 pass")
      AddGadgetItem(#pass,-1,"CRF 1 pass")
      AddGadgetItem(#pass,-1,"QP 1 pass")
      SetGadgetState(#pass,0)
      
      Frame3DGadget(#PB_Any, 233, 3, 218, 123, "Target Format")
      
      TextGadget(#Text_7,240,53,65,25,"Preset/Tune")
      ComboBoxGadget(#preset, 330, 50,115,comboheight )
      AddGadgetItem(#preset,-1,"No Preset")
      AddGadgetItem(#preset,-1,"ultrafast")
      AddGadgetItem(#preset,-1,"superfast")
      AddGadgetItem(#preset,-1,"veryfast")
      AddGadgetItem(#preset,-1,"faster")
      AddGadgetItem(#preset,-1,"fast")
      AddGadgetItem(#preset,-1,"medium")
      AddGadgetItem(#preset,-1,"slow")
      AddGadgetItem(#preset,-1,"slower")
      AddGadgetItem(#preset,-1,"veryslow")
      AddGadgetItem(#preset,-1,"placebo")
      SetGadgetState(#preset,6)
      
      TextGadget(#Text_8,240,78,65,25,"Tuning")
      ComboBoxGadget(#tuning, 330, 75, 115, comboheight)
      AddGadgetItem(#tuning,-1,"none")
      AddGadgetItem(#tuning,-1,"Film")
      AddGadgetItem(#tuning,-1,"Animation")
      AddGadgetItem(#tuning,-1,"Grain")
      AddGadgetItem(#tuning,-1,"StillImage")
      AddGadgetItem(#tuning,-1,"PSNR")
      AddGadgetItem(#tuning,-1,"SSIM")
      AddGadgetItem(#tuning,-1,"Fastdecode")
      AddGadgetItem(#tuning,-1,"Zerolatency")
      SetGadgetState(#tuning,0)
      
      ;TextGadget(#PB_Any,240,103,65,25,"Custom X264")
      ComboBoxGadget(#x264mod,240,100,205,20,#PB_ComboBox_Editable)
      ...
      StringGadget(#videolenght, 245, 170, 50, 20, "",#PB_String_ReadOnly)
      TextGadget(#PB_Any, 300, 173, 85, 20, "minutes keep in:")
      StringGadget(#cds,385,170,40,20,"700",#PB_String_Numeric)
      TextGadget(#PB_Any,430,173,20,20,"MB")
      ...
      Frame3DGadget(#PB_Any, 8, 5, 220, 170, "Audio Parameters")
      Frame3DGadget(#PB_Any, 238,5, 210,170, "Audio Options")
      
      TextGadget(#PB_Any, 18, 28, 80, 20, "Audio Codec:")
      
      ComboBoxGadget(#audiocodec, 98, 25,110,comboheight )
      ...
      CheckBoxGadget(#audionormalize, 248, 25, 150, 20, "Normalize Audio Track")
      ...
      TextGadget(#PB_Any,18, 20, 80, 20, "Select Resizer")
      ComboBoxGadget(#resizer, 105,18,110,comboheight)
      AddGadgetItem(#resizer,-1,"fastbilinear")
      AddGadgetItem(#resizer,-1,"bilinear")
      AddGadgetItem(#resizer,-1,"bicubic")
      AddGadgetItem(#resizer,-1,"experimental")
      AddGadgetItem(#resizer,-1,"point")
      AddGadgetItem(#resizer,-1,"area")
      AddGadgetItem(#resizer,-1,"bicublin")
      AddGadgetItem(#resizer,-1,"gauss")
      AddGadgetItem(#resizer,-1,"sinc")
      AddGadgetItem(#resizer,-1,"lanczos")
      AddGadgetItem(#resizer,-1,"spline")
      SetGadgetState(#resizer,2)
      
      
      TextGadget(#PB_Any,18, 50, 80, 20, "Denoise Level")
      ComboBoxGadget(#denoise, 105,48,110,comboheight)
      ...
      TextGadget(#PB_Any,18, 80, 80, 20, "Decode Video")
      ComboBoxGadget(#encodewith,105,78,225,comboheight)
      SetGadgetState(#encodewith,0)
      
      
      CheckBoxGadget(#clean,18,155,195,20,"Clean file at end of encoding")
      
      CheckBoxGadget(#shutdown,18,180,195,20,"Shutdown at end of encoding")
      
      ButtonGadget(#makereport,357,180,90,comboheight,"Make Report")
      ...
      ButtonGadget(#addtoqueue,18,177,90,comboheight,"Add to Queue")
      ButtonGadget(#removequeuejob,125,177,110,comboheight,"Remove job line")
      ButtonGadget(#startqueue,255,177,80,comboheight,"Start Queue")
      ButtonGadget(#buttonaddtoqueue,340,177 ,40,comboheight,"add ...")
    ...
    GadgetToolTip(#allowresize,"This option enable resize. It will be done by decoder (first choice) or by x264 (if compiled with resize support) ")
    GadgetToolTip(#x264mod,"Here you can write custom command line for x264. Just leave blank for no custom command")
    ...
    GadgetToolTip(#denoise,"Set denoise level. Used only for AviSynth and Mencoder decoder")
...
; Compiler = PureBasic 4.51 (Linux - x86)
